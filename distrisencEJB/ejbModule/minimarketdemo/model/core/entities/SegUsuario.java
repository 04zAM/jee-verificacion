...
public class SegUsuario implements Serializable {
	...
	public List<VenProforma> getVenProformas() {
		return this.venProformas;
	}

	public void setVenProformas(List<VenProforma> venProformas) {
		this.venProformas = venProformas;
	}

	public VenProforma addVenProforma(VenProforma venProforma) {
		getVenProformas().add(venProforma);
		venProforma.setSegUsuario(this);

		return venProforma;
	}

	public VenProforma removeVenProforma(VenProforma venProforma) {
		getVenProformas().remove(venProforma);
		venProforma.setSegUsuario(null);
